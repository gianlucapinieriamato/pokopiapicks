...
export const HABITATS: Record<string, HabitatEntry> = {
  ...
  bedwithaplush: {
    ...
    pokemon: ["drifloon", "slowbro", "munchlax", "slowking"],
  },
  benchwithgreenery: {
  ...
  "boulder-shadedtallgrass": {
    ...
    pokemon: ["timburr", "machop", "gurdurr"],
  },
  ...
  elevatedpinktallgrass: {
    ...
    pokemon: ["corvisquire", "kilowattrel", "wattrel", "corviknight"],
  },
  elevatedredtallgrass: {
    ...
    pokemon: ["murkrow", "chatot", "honchkrow"],
  },
  elevatedtallgrass: {
  ...
  elevatedyellowtallgrass: {
    ...
    pokemon: ["wingull", "pelipper", "crobat"],
  },
  evilorganizationhq: {
  ...
  fluffyflowerbed: {
    ...
    pokemon: ["vulpix", "rookidee", "mismagius", "misdreavus", "ninetales"],
  },
  freshveggiefield: {
    ...
    pokemon: ["drilbur", "rowlet", "excadrill"],
  },
  fullrecovery: {
    slug: "fullrecovery",
    name: "Full recovery",
  ...
  gracefulflowerbed: {
    ...
    pokemon: ["cleffa", "fidough", "clefable", "clefairy", "dachsbun"],
  },
  grassytrainingfield: {
  ...
  hydratedtallgrass: {
    ...
    pokemon: ["squirtle", "sliggoo", "blastoise", "cramorant", "wartortle"],
  },
  ...
  largeluggagecarrier: {
    ...
    pokemon: ["tinkatink", "gurdurr", "tinkatuff"],
  },
  ...
  musicandmagazines: {
    ...
    pokemon: ["kricketot", "kricketune", "stereorotom"],
  },
  nightfestivalvenue: {
  ...
  oceanfishingspot: {
    ...
    pokemon: ["magikarp", "gastrodon", "gastrodoneastsea"],
  },
  officestoreroom: {
  ...
  pinktallgrass: {
    ...
    pokemon: ["trapinch", "duskull", "vibrava", "swablu", "flygon"],
  },
  "piping-hotlava": {
    slug: "piping-hotlava",
  ...
  prettyflowerbed: {
    ...
    pokemon: ["pidgey", "combee", "eevee", "hoothoot", "magby", "pidgeotto"],
  },
  privatemakeupstand: {
  ...
  railroadcrossing: {
    ...
    pokemon: ["carkol", "rolycoly", "coalossal"],
  },
  raindancesite: {
    slug: "raindancesite",
  ...
  redtallgrass: {
    ...
    pokemon: ["scorbunny", "riolu", "cinderace", "kricketot", "kricketune"],
  },
  ...
  roadsign: {
    ...
    pokemon: ["shellos", "shelloseastsea"],
  },
  sailfossildisplay: {
  ...
  surpriseinstore: {
    ...
    pokemon: ["haunter", "zoroark", "gengar"],
  },
  ...
  trashcancentral: {
    ...
    pokemon: ["magneton", "electabuzz", "magnezone"],
  },
  trashcollectionsite: {
    ...
    pokemon: ["trubbish", "koffing", "weezing", "garbodor"],
  },
  trashdisposalsite: {
  ...
  "tree-shadedflowerbed": {
    ...
    pokemon: ["goomy", "cacturne", "vikavolt"],
  },
  ...
  workingtheregister: {
    ...
    pokemon: ["meowth", "audino", "happiny", "mawile"],
  },
  yellowcarpet: {
    slug: "yellowcarpet",
    name: "Yellow carpet",
  ...
  yellowtallgrass: {
    ...
    pokemon: ["spinarak", "grubbin", "ariados"],
  },
};
